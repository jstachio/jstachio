...
final class ServicesFiles {
    ...
    /**
     * Returns an absolute path to a service file given the class name of the
     * service.
     *
     * @param serviceName
     *            not {@code null}
     ...
     *
     * @param output
     *            not {@code null}. Not closed after use.
     * @param services
     *            a not {@code null Collection} of service class names.
     * @throws IOException
     */
    ...
    public static void writeServicesFile(Filer filer, Messager messager, ClassRef serviceInterface, Iterable<ClassRef> classes) {
        ...
        try {
            FileObject existingFile = createResourceFile(filer,
                    serviceFile);
