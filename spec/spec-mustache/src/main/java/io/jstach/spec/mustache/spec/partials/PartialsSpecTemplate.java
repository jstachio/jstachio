...
public enum PartialsSpecTemplate implements SpecListing {
	...
	BASIC_BEHAVIOR(BasicBehavior.class, "partials", "Basic Behavior",
			"The greater-than operator should expand to the named partial.", "{}", "\"{{>text}}\"", "\"from partial\"",
			Map.of(
	...
	FAILED_LOOKUP(null, "partials", "Failed Lookup",
			"The empty string should be used when the named partial is not found.", "{}", "\"{{>text}}\"", "\"\"",
			Map.of()) {
		public String render(Map<String, Object> o) {
			return "DISABLED TEST";
		}
	},
	CONTEXT(Context.class, "partials", "Context",
			"The greater-than operator should operate within the current context.", "{\"text\":\"content\"}",
			"\"{{>partial}}\"", "\"*content*\"", Map.of(
	...
	RECURSION(null, "partials", "Recursion", "The greater-than operator should properly recurse.",
			"{\"content\":\"X\",\"nodes\":[{\"content\":\"Y\",\"nodes\":[]}]}", "{{>node}}", "X<Y<>>", Map.of(
	...
	SURROUNDING_WHITESPACE(SurroundingWhitespace.class, "partials", "Surrounding Whitespace",
			"The greater-than operator should not alter surrounding whitespace.", "{}", "| {{>partial}} |", "| \t|\t |",
			Map.of(
	...
	INLINE_INDENTATION(InlineIndentation.class, "partials", "Inline Indentation",
			"Whitespace should be left untouched.", "{\"data\":\"|\"}", "  {{data}}  {{> partial}}\n", "  |  >\n>\n",
			Map.of(
	...
	STANDALONE_INDENTATION(StandaloneIndentation.class, "partials", "Standalone Indentation",
			"Each line of the partial should be indented before rendering.", "{\"content\":\"<\\n->\"}",
			"\\\n {{>partial}}\n/\n", "\\\n |\n <\n->\n |\n/\n", Map.of(
	...
	PADDING_WHITESPACE(PaddingWhitespace.class, "partials", "Padding Whitespace",
			"Superfluous in-tag whitespace should be ignored.", "{\"boolean\":true}", "|{{> partial }}|", "|[]|",
			Map.of(
	...
	private PartialsSpecTemplate(Class<?> modelClass, String group, String title, String description, String json,
