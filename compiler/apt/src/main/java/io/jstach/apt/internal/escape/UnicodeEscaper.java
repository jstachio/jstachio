...
class UnicodeEscaper extends CodePointTranslator {
	...
	/**
	 * Constructs a {@code UnicodeEscaper} for the specified range. This is the underlying
	 * method for the other constructors/builders. The {@code below} and {@code above}
	 * boundaries are inclusive when {@code between} is {@code true} and exclusive when it
	 * is {@code false}.
