...
/**
 * Helper subclass to CharSequenceTranslator to allow for translations that will replace
 * up to one character at a time.
 *
 * @since 1.0
 */
abstract class CodePointTranslator extends CharSequenceTranslator {
	...
	/**
	 * Implementation of translate that maps onto the abstract translate(int, Writer)
	 * method. {@inheritDoc}
	 */
	@Override
