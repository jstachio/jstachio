...
class LookupTranslator extends CharSequenceTranslator {
	 ...
	 *
	 * Note that, as of Lang 3.1 (the origin of this code), the key to the lookup table is
	 * converted to a java.lang.String. This is because we need the key to support
