...
/**
 * This interface is to allow you to simulate JSON node like trees without being coupled
 * to a particularly JSON lib.
 *
 * It is not recommended you use this extension point as it generally avoids the type
 * checking safty of this library.
 *
...
public interface ContextNode extends Iterable<ContextNode> {
	...
	/**
	 * Gets a field from java.util.Map if ContextNode is wrapping one. This is direct
	 * access and does not check the parents.
	 *
